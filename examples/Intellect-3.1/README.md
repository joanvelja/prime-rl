...
If you don't have access to that many nodes, you can downscale inference nodes and training nodes to lower values and scale down the batch size accordingly.

For the training nodes, going below 4 nodes might cause OOM, feel free to follow this section to reduce memory usage. TODO sami add the section
